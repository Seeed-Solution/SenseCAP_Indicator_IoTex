...
esp_event_loop_handle_t data_event_handle;
...
void app_main(void)
{
    ...
    esp_event_loop_args_t data_event_task_args = {
        .queue_size      = 3,
        .task_name       = "data_event_task",
        .task_priority   = uxTaskPriorityGet(NULL),
        .task_stack_size = 4096,
        .task_core_id    = tskNO_AFFINITY};
    ...
    ESP_ERROR_CHECK(esp_event_loop_create(&data_event_task_args, &data_event_handle));
