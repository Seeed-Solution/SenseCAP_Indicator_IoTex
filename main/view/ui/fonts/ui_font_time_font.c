 ...
 * Size: 140 px
 * Bpp: 8
 * Opts: --bpp 8 --size 140 --font Z:\SenseCAP_Indicator_IoTex\sensecap_d1_IoTex\assets\Montserrat-SemiBold.ttf -o Z:\SenseCAP_Indicator_IoTex\sensecap_d1_IoTex\assets\ui_font_time_font.c --format lvgl -r 0x30-0x39 --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_TIME_FONT
#define UI_FONT_TIME_FONT 1
#endif

#if UI_FONT_TIME_FONT
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_time_font = {
#else
lv_font_t ui_font_time_font = {
#endif
