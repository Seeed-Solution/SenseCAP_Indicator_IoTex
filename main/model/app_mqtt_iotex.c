...
#define EVENT_UPLOAD_DATA_CODE 0
        ...
        case DATA_EVENT_SRNSOR_CAPTURE: // catupre data from sensor
        {
            ...
            switch (p_data->sensor_type) {
                case SENSOR_DATA_CO2: {
                    ...
                    esp_event_post_to(data_event_handle, DATA_EVENT_BASE, EVENT_UPLOAD_DATA_CODE, &sensor_data, sizeof(sensor_data_t), portMAX_DELAY);
...
void iotex_upload_data_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_event_handler_instance_register_with(data_event_handle,
                                                             DATA_EVENT_BASE, DATA_EVENT_SRNSOR_CAPTURE,
                                                             __data_event_handler, NULL, NULL));

    ESP_ERROR_CHECK(esp_event_handler_instance_register_with(data_event_handle,
                                                             DATA_EVENT_BASE, DATA_EVENT_SRNSOR_UPLOAD,
                                                             __data_event_handler, NULL, NULL));
}
